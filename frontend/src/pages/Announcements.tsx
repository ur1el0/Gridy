...
export const Announcements: React.FC = () => {
    ...
    if (loading && announcements.length === 0) return <div className="p-8 text-slate-500 flex items-center gap-2"><div className="w-4 h-4 border-2 border-[#0047BA] border-t-transparent rounded-full animate-spin"></div> Loading...</div>;
